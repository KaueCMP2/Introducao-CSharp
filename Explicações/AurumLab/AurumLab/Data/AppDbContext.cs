...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdDispositivo).HasName("PK__Disposit__B1EDB8E4CB79296D");
        ...
        {
            entity.HasKey(e => e.IdLocal).HasName("PK__LocalDis__C287B9BB6CF18155");
        ...
        {
            entity.HasKey(e => e.IdManutencao).HasName("PK__Manutenc__CD0C6B2A5698894D");
        ...
        {
            entity.HasKey(e => e.IdRegra).HasName("PK__RegraPer__E4F2CC247DF7E9FB");

            entity.ToTable("RegraPerfil");

            entity.HasIndex(e => e.Nome, "UQ__RegraPer__7D8FE3B2177EB365").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdTipoDispositivo).HasName("PK__TipoDisp__A9EEE648F194D342");
        ...
        {
            entity.HasKey(e => e.IdTipoManutencao).HasName("PK__TipoManu__BE62BE4EAF2DAC94");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF979D1361F0");

            entity.ToTable("Usuario");

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534840DF390").IsUnique();
